  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentBackground((prevBackground) => {
        ...
        const newHue = approachValue(prevHue, targetHue, 10) // Extremely small step for hue
        const newSaturation = approachValue(prevSaturation, targetSaturation, 5)
        const newLightness = approachValue(prevLightness, targetLightness, 5)
